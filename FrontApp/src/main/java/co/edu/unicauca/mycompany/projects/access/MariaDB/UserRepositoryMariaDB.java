 ...
 */
public class UserRepositoryMariaDB extends MariaDBConnection implements IUserRepository {
    ...
    public boolean save(User newUser) {
        try {
            ...
            pstmtUser.setString(1, newUser.getId());
            pstmtUser.setString(2, newUser.getEmail());
            pstmtUser.setString(3, newUser.getPassword());
            ...
            pstmtRol.setString(1, newUser.getId());
            ...
            Logger.getLogger(UserRepositoryMariaDB.class.getName()).log(Level.SEVERE, "Error al guardar usuario y rol", ex);
        }
        return false;
    }
    ...
    public boolean existId(String id) {
        ...
        try {
            ...
            Logger.getLogger(UserRepositoryMariaDB.class.getName()).log(Level.SEVERE, "Error al verificar existencia de userId", ex);
        } finally {
