 ...
 */
public class CompanyRepositoryMariaDB extends MariaDBConnection implements ICompanyRepository {

    /**
     * Constructor de la clase.
     */
    public CompanyRepositoryMariaDB() {
    }
    ...
    public boolean save(Company newCompany) {
        try {
            ...
            pstmt.setString(1, newCompany.getId());
            ...
            Logger.getLogger(CompanyRepositoryMariaDB.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
    ...
    public Company companyInfo(String nit) {
        ...
        try {
            ...
            Logger.getLogger(CompanyRepositoryMariaDB.class.getName()).log(Level.SEVERE, "Error al obtener los datos.", e);
        } finally {
            disconnect();
        }
        return company;
    ...
    public String getSectorIdByName(String sectorName) {
        ...
        try {
            ...
            Logger.getLogger(CompanyRepositoryMariaDB.class.getName()).log(Level.SEVERE, "Error al obtener secId del sector", ex);
        }
        return sectorId;
    }
