 ...
 * 
 */
public class StudentRepositoryMariaDB extends MariaDBConnection implements IStudentRepository {
    ...
    */
    public StudentRepositoryMariaDB() {
    }
    ...
    public Student getStudent(String userId) {
        ...
        try {
            ...
            Logger.getLogger(StudentRepositoryMariaDB.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            disconnect();
        }
